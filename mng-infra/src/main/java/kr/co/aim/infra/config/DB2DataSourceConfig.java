...
@EnableJpaRepositories(
        basePackages = "kr.co.aim.infra.persistence.springdatajpadb2", // 1. 이 설정은 이 패키지의 리포지토리를 담당!
...
public class DB2DataSourceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean db2EntityManagerFactory(
        ...
        return builder
                ...
                .packages("kr.co.aim.infra.persistence.entitydb2") // 4. 이 EntityManager는 이 패키지의 엔티티만 스캔!
                .build();
    }
