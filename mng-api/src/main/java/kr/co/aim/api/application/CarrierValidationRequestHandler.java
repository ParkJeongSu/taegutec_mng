...
public class CarrierValidationRequestHandler implements MessageHandler<String> {
    ...
    public String getSupportedMessageName() {
        return MessageList.CARRIER_VALIDATION_REQUEST.getMessageName();
    }
    ...
    public Object handle(String message) {
        ...
        // 2. 해당 비즈니스 로직 호출
        // 서비스 호출
        BaseMessage<CarrierValidationReplyBody> reply = carrierService.carrierValidationRequest(requestMessage);
