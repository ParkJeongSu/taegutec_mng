...
@Slf4j
public class ProcessProductionTypeStrategy implements ProductionOrderProcessStrategy {
    ...
    public boolean supports(ProductionOrderProcessContext context) {
        return context.getProductionOrder().getProductionOrderType().equals(ProductionOrderType.PRODUCTION.getValue());
    }
