...
import kr.co.aim.common.format.CarrierDataRemovedBody;
...
public class CarrierDataRemovedHandler implements MessageHandler<String> {
    ...
    public String getSupportedMessageName() {
        return MessageList.CARRIER_DATA_REMOVED.getMessageName();
    }
    ...
    public Object handle(String message) {
        ...
        // 1. 자신에게 맞는 DTO로 역직렬화
        TypeReference<BaseMessage<CarrierDataRemovedBody>> typeRef = new TypeReference<>() {};
        BaseMessage<CarrierDataRemovedBody> requestMessage = objectMapper.readValue(message, typeRef);

        // 2. 해당 비즈니스 로직 호출
        // 서비스 호출
        messageExecuteService.carrierDataRemoved(requestMessage);
