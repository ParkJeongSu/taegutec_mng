...
import kr.co.aim.common.format.DestinationRequestBody;
...
public class DestinationRequestHandler implements MessageHandler<String> {
    ...
    public String getSupportedMessageName() {
        return MessageList.DESTINATION_REQUEST.getMessageName();
    }
    ...
    public Object handle(String message) {
        ...
        // 1. 자신에게 맞는 DTO로 역직렬화
        TypeReference<BaseMessage<DestinationRequestBody>> typeRef = new TypeReference<>() {};
        BaseMessage<DestinationRequestBody> requestMessage = objectMapper.readValue(message, typeRef);
