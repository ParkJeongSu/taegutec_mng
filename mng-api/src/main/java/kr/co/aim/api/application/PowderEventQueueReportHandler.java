...
@Profile({"scheduler"})
public class PowderEventQueueReportHandler implements MessageHandler<String> {
    ...
    public String getSupportedMessageName() {
        return MessageList.POWDER_EVENT_QUEUE_REPORT.getMessageName();
    }
    ...
    public Object handle(String message) {
        ...
        // 1. 자신에게 맞는 DTO로 역직렬화
        TypeReference<BaseMessage<EventQueueReportBody>> typeRef = new TypeReference<>() {};
        BaseMessage<EventQueueReportBody> requestMessage = objectMapper.readValue(message, typeRef);
