...
import kr.co.aim.common.format.CarrierSynchronizationRequestByWMSBody;
...
@Profile({"pex","tex"})
public class CarrierSynchronizationRequestHandler implements MessageHandler<String> {
    ...
    public String getSupportedMessageName() {
        return MessageList.CARRIER_SYNCHRONIZATION_REQUEST.getMessageName();
    }
    ...
    public Object handle(String message) {
        ...
        // 1. 자신에게 맞는 DTO로 역직렬화
        TypeReference<BaseMessage<CarrierSynchronizationRequestByWMSBody>> typeRef = new TypeReference<>() {};
        BaseMessage<CarrierSynchronizationRequestByWMSBody> request = objectMapper.readValue(message, typeRef);
