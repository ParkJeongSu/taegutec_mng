...
import kr.co.aim.common.format.TransportJobValidationReplyBody;
...
@Profile({"pex","tex"})
public class TransportJobValidationReplyHandler implements MessageHandler<String> {
    ...
    public String getSupportedMessageName() {
        return MessageList.TRANSPORT_JOB_VALIDATION_REPLY.getMessageName();
    }
    ...
    public Object handle(String message) {
        ...
        // 1. 자신에게 맞는 DTO로 역직렬화
        TypeReference<BaseMessage<TransportJobValidationReplyBody>> typeRef = new TypeReference<>() {};
        BaseMessage<TransportJobValidationReplyBody> requestMessage = objectMapper.readValue(message, typeRef);
