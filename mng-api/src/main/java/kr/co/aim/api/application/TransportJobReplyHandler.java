...
@Profile({"pex","tex"})
public class TransportJobReplyHandler implements MessageHandler<String> {
    ...
    public String getSupportedMessageName() {
        return MessageList.TRANSPORT_JOB_REPLY.getMessageName();
    }
    ...
    public Object handle(String message) {
        ...
        // 1. 자신에게 맞는 DTO로 역직렬화
        TypeReference<BaseMessage<TransportJobReplyBody>> typeRef = new TypeReference<>() {};
        BaseMessage<TransportJobReplyBody> requestMessage = objectMapper.readValue(message, typeRef);
